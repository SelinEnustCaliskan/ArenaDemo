...
{  
    public partial class TextMeshProUGUI
    {
        ...
        protected override void OnDisable()
        {
            ...
            if (m_canvasRenderer != null)
                m_canvasRenderer.Clear();  // Might not want to clear since it wipes the Material in addition to the mesh geometry.
        ...
        protected override int SetArraySizes(int[] chars)
        {
            ...
            for (int i = 0; chars[i] != 0; i++)
            {
                ...
                if (m_currentFontAsset.characterDictionary.TryGetValue(c, out glyph) == false)
                {
                    ...
                    if (m_currentFontAsset.fallbackFontAssets != null && m_currentFontAsset.fallbackFontAssets.Count > 0)
                    {
                        ...
                        for (int y = 0; y < m_currentFontAsset.fallbackFontAssets.Count; y++)
                        {
                            ...
                            if (tempFontAsset.characterDictionary.TryGetValue(c, out glyph))
                            {
                                ...
                                m_currentMaterial = tempFontAsset.material;
                    ...
                    if (glyph == null)
                    {
                        if (m_currentFontAsset.characterDictionary.TryGetValue(9633, out glyph))
                        {
                        ...
                        else
                        {
                            ...
                            if (TMP_Settings.fallbackFontAssets != null && TMP_Settings.fallbackFontAssets.Count > 0)
                            {
                                ...
                                for (int y = 0; y < TMP_Settings.fallbackFontAssets.Count; y++)
                                {
                                    ...
                                    if (tempFontAsset.characterDictionary.TryGetValue(9633, out glyph))
                                    {
                            ...
                            if (glyph == null)
                            {
                                ...
                                if (tempFontAsset != null && tempFontAsset.characterDictionary.TryGetValue(9633, out glyph))
                                {
                                    // Use Square Missing Glyph from Default Font Asset.
                                    if (!TMP_Settings.warningsDisabled) Debug.LogWarning("Character with ASCII value of " + c + " was not found in the Font Asset Glyph Table.", this);
                ...
                if (!char.IsWhiteSpace((char)c))
                {
                    ...
                    // HANDLE FONT WEIGHTS
                    #region FONT WEIGHTS
                    //switch (m_fontWeightInternal)
                    //{
                    //    case 400: // Normal
                    //        if (isItalic)
                    //        {
                    //            if (m_currentFontAsset.normal.italic != null)
                    //            {
                    //                m_currentMaterialIndex = MaterialReference.AddMaterialReference(m_currentFontAsset.normal.italic.material, m_currentFontAsset.normal.italic, m_materialReferences, m_materialReferenceIndexLookup);
                    //                isUsingAlternativeTypeface = true;
                    //            } 
                    //        }

                    //        // We use the current normal font.
                    //        break;
                    //    case 100: // Thin
                    //        if (isItalic)
                    //        {
                    //            if (m_currentFontAsset.thin.italic != null)
                    //            {
                    //                m_currentMaterialIndex = MaterialReference.AddMaterialReference(m_currentFontAsset.thin.italic.material, m_currentFontAsset.thin.italic, m_materialReferences, m_materialReferenceIndexLookup);
                    //                isUsingAlternativeTypeface = true;
                    //            }
                    //        }
                    //        else
                    //        {
                    //            if (m_currentFontAsset.thin.regular != null)
                    //            {
                    //                m_currentMaterialIndex = MaterialReference.AddMaterialReference(m_currentFontAsset.thin.regular.material, m_currentFontAsset.thin.regular, m_materialReferences, m_materialReferenceIndexLookup);
                    //                isUsingAlternativeTypeface = true;
                    //            }
                    //        }
                    //        break;
                    ...
                    //        if (isItalic)
                    //        {
                    //            if (m_currentFontAsset.extraLight.italic != null)
                    //            {
                    //                m_currentMaterialIndex = MaterialReference.AddMaterialReference(m_currentFontAsset.extraLight.italic.material, m_currentFontAsset.extraLight.italic, m_materialReferences, m_materialReferenceIndexLookup);
                    //                isUsingAlternativeTypeface = true;
                    //            }
                    //        }
                    //        else
                    //        {
                    //            if (m_currentFontAsset.extraLight.regular != null)
                    //            {
                    //                m_currentMaterialIndex = MaterialReference.AddMaterialReference(m_currentFontAsset.extraLight.regular.material, m_currentFontAsset.extraLight.regular, m_materialReferences, m_materialReferenceIndexLookup);
                    //                isUsingAlternativeTypeface = true;
                    //            }
                    //        }
                    //        break;
                    ...
                    //        if (isItalic)
                    //        {
                    //            if (m_currentFontAsset.light.italic != null)
                    //            {
                    //                m_currentMaterialIndex = MaterialReference.AddMaterialReference(m_currentFontAsset.light.italic.material, m_currentFontAsset.light.italic, m_materialReferences, m_materialReferenceIndexLookup);
                    //                isUsingAlternativeTypeface = true;
                    //            }
                    //        }
                    //        else
                    //        {
                    //            if (m_currentFontAsset.light.regular != null)
                    //            {
                    //                m_currentMaterialIndex = MaterialReference.AddMaterialReference(m_currentFontAsset.light.regular.material, m_currentFontAsset.light.regular, m_materialReferences, m_materialReferenceIndexLookup);
                    //                isUsingAlternativeTypeface = true;
                    //            }
                    //        }
                    //        break;
                    ...
                    //        if (isItalic)
                    //        {
                    //            if (m_currentFontAsset.medium.italic != null)
                    //            {
                    //                m_currentMaterialIndex = MaterialReference.AddMaterialReference(m_currentFontAsset.medium.italic.material, m_currentFontAsset.medium.italic, m_materialReferences, m_materialReferenceIndexLookup);
                    //                isUsingAlternativeTypeface = true;
                    //            }
                    //        }
                    //        else
                    //        {
                    //            if (m_currentFontAsset.medium.regular != null)
                    //            {
                    //                m_currentMaterialIndex = MaterialReference.AddMaterialReference(m_currentFontAsset.medium.regular.material, m_currentFontAsset.medium.regular, m_materialReferences, m_materialReferenceIndexLookup);
                    //                isUsingAlternativeTypeface = true;
                    //            }
                    //        }
                    //        break;
                    ...
                    //        if (isItalic)
                    //        {
                    //            if (m_currentFontAsset.demiBold.italic != null)
                    //            {
                    //                m_currentMaterialIndex = MaterialReference.AddMaterialReference(m_currentFontAsset.demiBold.italic.material, m_currentFontAsset.demiBold.italic, m_materialReferences, m_materialReferenceIndexLookup);
                    //                isUsingAlternativeTypeface = true;
                    //            }
                    //        }
                    //        else
                    //        {
                    //            if (m_currentFontAsset.demiBold.regular != null)
                    //            {
                    //                m_currentMaterialIndex = MaterialReference.AddMaterialReference(m_currentFontAsset.demiBold.regular.material, m_currentFontAsset.demiBold.regular, m_materialReferences, m_materialReferenceIndexLookup);
                    //                isUsingAlternativeTypeface = true;
                    //            }
                    //        }
                    //        break;
                    ...
                    //        if (isItalic)
                    //        {
                    //            if (m_currentFontAsset.bold.italic != null)
                    //            {
                    //                m_currentMaterialIndex = MaterialReference.AddMaterialReference(m_currentFontAsset.bold.italic.material, m_currentFontAsset.bold.italic, m_materialReferences, m_materialReferenceIndexLookup);
                    //                isUsingAlternativeTypeface = true;
                    //            }
                    //        }
                    //        else
                    //        {
                    //            if (m_currentFontAsset.bold.regular != null)
                    //            {
                    //                m_currentMaterialIndex = MaterialReference.AddMaterialReference(m_currentFontAsset.bold.regular.material, m_currentFontAsset.bold.regular, m_materialReferences, m_materialReferenceIndexLookup);
                    //                isUsingAlternativeTypeface = true;
                    //            }
                    //        }
                    //        break;
                    ...
                    //        if (isItalic)
                    //        {
                    //            if (m_currentFontAsset.heavy.italic != null)
                    //            {
                    //                m_currentMaterialIndex = MaterialReference.AddMaterialReference(m_currentFontAsset.heavy.italic.material, m_currentFontAsset.heavy.italic, m_materialReferences, m_materialReferenceIndexLookup);
                    //                isUsingAlternativeTypeface = true;
                    //            }
                    //        }
                    //        else
                    //        {
                    //            if (m_currentFontAsset.heavy.regular != null)
                    //            {
                    //                m_currentMaterialIndex = MaterialReference.AddMaterialReference(m_currentFontAsset.heavy.regular.material, m_currentFontAsset.heavy.regular, m_materialReferences, m_materialReferenceIndexLookup);
                    //                isUsingAlternativeTypeface = true;
                    //            }
                    //        }
                    //        break;
                    ...
                    //        if (isItalic)
                    //        {
                    //            if (m_currentFontAsset.black.italic != null)
                    //            {
                    //                m_currentMaterialIndex = MaterialReference.AddMaterialReference(m_currentFontAsset.black.italic.material, m_currentFontAsset.black.italic, m_materialReferences, m_materialReferenceIndexLookup);
                    //                isUsingAlternativeTypeface = true;
                    //            }
                    //        }
                    //        else
                    //        {
                    //            if (m_currentFontAsset.black.regular != null)
                    //            {
                    //                m_currentMaterialIndex = MaterialReference.AddMaterialReference(m_currentFontAsset.black.regular.material, m_currentFontAsset.black.regular, m_materialReferences, m_materialReferenceIndexLookup);
                    //                isUsingAlternativeTypeface = true;
                    //            }
                    //        }
                    //        break;
                    ...
                    if (isUsingAlternativeTypeface) m_currentMaterialIndex = prev_materialIndex;
            ...
            for (int i = 0; i < materialCount; i++)
            {
                ...
                if (i > 0)
                {
                    ...
                    if (m_subTextObjects[i].sharedMaterial == null || m_subTextObjects[i].sharedMaterial.GetInstanceID() != m_materialReferences[i].material.GetInstanceID())
                    {
                        ...
                        if (!isDefaultMaterial || m_subTextObjects[i].sharedMaterial == null || m_subTextObjects[i].sharedMaterial.mainTexture.GetInstanceID() != m_materialReferences[i].material.mainTexture.GetInstanceID())
                        {
        ...
        void LateUpdate()
        {
            if (m_rectTransform.hasChanged)
            {
                ...
                if (!m_havePropertiesChanged && currentLossyScale.y != m_previousLossyScale.y && m_text != string.Empty && m_text != null)
                {
                    UpdateSDFScale(currentLossyScale.y);
        ...
        protected override void GenerateTextMesh()
        {
            ...
            for (int i = 0; m_char_buffer[i] != 0; i++)
            {
                ...
                {   // This is a Space, Tab, LineFeed or Carriage Return
                    ...
                    if (charCode == 10 || char.IsSeparator((char)charCode))
                    {
                        m_textInfo.lineInfo[m_lineNumber].spaceCount += 1;
                        m_textInfo.spaceCount += 1;
                    }
            ...
            float lossyScale = m_rectTransform.lossyScale.y != 0 ? m_rectTransform.lossyScale.y : 1;
            ...
            for (int i = 0; i < m_characterCount; i++)
            {
                ...
                #endif
                if (char.IsLetterOrDigit(currentCharacter) || currentCharacter == 45 || currentCharacter == 8217)
                {
                ...
                {
                    if (i > 0 && i < m_characterCount && currentCharacter == 39 && char.IsLetterOrDigit(characterInfos[i - 1].character) && char.IsLetterOrDigit(characterInfos[i + 1].character))
                    {
